...
def print_report(result: ScanResult) -> None:
    ...
    console.print(
        Panel.fit(
            "[bold]SpiderShield Agent Security Check[/bold]",
...
def _print_summary(result: ScanResult) -> None:
    ...
    if fixable:
        summary_parts.append(
            f"\n[dim]Run [bold]spidershield agent-check --fix[/bold] to auto-fix "
...
def print_fix_report(fixes: list[str]) -> None:
    ...
    console.print()
    console.print(Panel.fit("[bold]SpiderShield Auto-Fix Results[/bold]"))
    console.print()
