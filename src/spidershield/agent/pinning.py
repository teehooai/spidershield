...
DEFAULT_PIN_DIR = Path.home() / ".spidershield"
...
def pin_skill(
    ...
    Args:
        ...
        pin_dir: Directory for pins.json. Defaults to ~/.spidershield/.
...
def verify_skill(
    ...
    if skill_name not in pins:
        return SkillFinding(
            ...
            issues=["Skill is not pinned — run 'spidershield agent-pin add' to establish baseline"],
        )
