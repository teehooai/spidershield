...
| **Obs 001A rev9** | **2026-03-13** | **Self-audit round 1: 5 scanner bugs fixed (re.MULTILINE, docstring parsing, force_regex, pattern coverage, multi-line subprocess). 75/75 tests pass.** |
| **Obs 001A rev10** | **2026-03-13** | **Deep core code review: 23 bugs fixed across all modules (9 HIGH, 10 MEDIUM, 4 LOW). Key fixes: _score_tests path bug (#1), desc_pat triple-quote ordering (#3), tool extraction type annotation (#4), rewriter backup+sanitization+targeted replace (#5-7), git clone flag injection (#8), SQL case sensitivity (#9), Object.assign FP (#10), verb stemming (#11), param_docs/error_guidance FP reduction (#12-13), Go NewTool cross-match (#14), multi-line signature detection (#15), subprocess boundary (#16), TS type_hint short-circuit (#17), skill_scanner DOTALL (#18), model defaults (#19), CLAUDE.md doc sync (#20), test file counting (#21), type hint regex (#22), temp dir cleanup (#23), single-tool disambiguation (#24). Score: A (9.0) → A+ (9.3).** |
